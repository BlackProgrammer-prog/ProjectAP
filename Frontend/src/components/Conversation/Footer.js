...
import { Smiley, LinkSimple, PaperPlaneTilt, Sticker, Camera, User, Image, File } from "phosphor-react"
...
const ChatInput = ({ setOpenPicker, openActions, setOpenActions }) => {
            ...
            >
                <Stack direction="row" alignItems="center" spacing={2}>
                    <Stack sx={{ width: "100%", position: "relative" }}>
                        ...
                        <ChatInput setOpenPicker={setOpenPicker} openActions={openActions} setOpenActions={setOpenActions} />
                    </Stack>
...
// import { useState } from "react"
// import { Box, Stack, TextField, InputAdornment, useTheme, IconButton, Fab } from "@mui/material"
...
//                                     top: "-5px",
//                                     left: "50%",
//                                     transform: `translateX(-50%) ${openActions ? "rotate(45deg)" : "rotate(0deg)"}`,
//                                 }}
//                             >
//                                 <LinkSimple size={20} />
//                             </IconButton>
...
//             <Box
//                 sx={{
//                     width: "calc(100% - 40px - 320px)", // Adjusted for contact panel
//                     maxWidth: "1088px",
//                     backgroundColor: theme.palette.mode === "light" ? "#F8FAFF" : theme.palette.background.paper,
//                     boxShadow: "0px 0px 2px rgba(0,0,0,0.25)",
//                     position: "fixed",
