...
const Message = ({ messages, onDeleteMessage, onReactionChange, onForwardMessage, onEditMessage, onReportMessage, isSearchActive, searchQuery, onSearchChange, isGroup = false }) => {
